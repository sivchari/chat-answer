...
||||||| parent of d867a22 (update: proto)
=======
// @generated by protoc-gen-connect-web v0.10.0 with parameter "target=ts"
// @generated from file proto/chat.proto (package api, syntax proto3)
/* eslint-disable */
...
import { CreateRoomRequest, CreateRoomResponse, ListRoomResponse, SendMessageRequest } from "./chat_pb.js";
import { Empty, MethodKind } from "@bufbuild/protobuf";
...
export const ChatService = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc api.ChatService.SendMessage
     */
    sendMessage: {
      name: "SendMessage",
