...
const (
	...
	RoomServiceName = "api.RoomService"
)
...
func (c *roomServiceClient) CreateRoom(ctx context.Context, req *connect_go.Request[proto.CreateRoomRequest]) (*connect_go.Response[proto.CreateRoomResponse], error) {
